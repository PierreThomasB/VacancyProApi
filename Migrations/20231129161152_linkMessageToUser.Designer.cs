...
namespace VacancyProAPI.Migrations
{
    ...
    [Migration("20231129161152_linkMessageToUser")]
    partial class linkMessageToUser
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VacancyProAPI.Models.DbModels.Notification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("VacancyProAPI.Models.DbModels.Place", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("VacancyProAPI.Models.DbModels.Chat", b =>
                {
                    b.HasOne("VacancyProAPI.Models.DbModels.User", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
